...
class BT:
    ...
    def depth(self) -> int:
        ...
        if self._data == None: return 0
        elif self.left_child() == None and self.right_child() == None: return 1
        elif self.left_child() == None: return 1 + self.right_child().depth()
        elif self.right_child() == None: return 1 + self.left_child().depth()
        else: return 1 + max(self.left_child().depth(), self.right_child().depth())
    ...
    def pre_order(self) -> List[Any]:
        ...
        if self.left_child() != None: lst.extend(self._left.pre_order())
        if self.right_child() != None: lst.extend(self._right.pre_order())
    ...
    def in_order(self) -> List[Any]:
        ...
        if self.left_child() != None: lst.extend(self._left.in_order())
        lst.append(self._data)
        if self.right_child() != None: lst.extend(self._right.in_order())
    ...
    def post_order(self) -> List[Any]:
        ...
        if self.left_child() != None: lst.extend(self._left.post_order())
        if self.right_child() != None:lst.extend(self._right.post_order())
        lst.append(self._data)
